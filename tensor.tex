...
\begin{definition}[tensor category]
  ...
  such that
  \begin{enumerate}
    \item the tensor product functor $\otimes\colon \mathsf{A} \times \mathsf{A} \rightarrow \mathsf{A}$ is, in both arguments separately,
      \begin{enumerate}
    ...
    \item $\mathrm{End}(1) \simeq k$, where $\mathrm{End}$ denotes the endomorphism ring
  \end{enumerate}
\end{definition}
