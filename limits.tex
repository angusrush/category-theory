...
\begin{example}
  ...
  A diagram of type $\mathsf{J}$ in a category $\mathsf{C}$ is a functor $\mathsf{J} \to \mathsf{C}$, which picks out three objects and two morphisms in $\mathsf{C}$ as follows.
  \begin{equation*}
    \begin{tikzcd}
      & y
      \arrow[d, "f"]
