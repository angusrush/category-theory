...
\begin{theorem}
  \label{thm:kan_extensions_exist_when_we_have_enough_limits}
...
\begin{definition}[limit over a comma category]
...
\begin{definition}[Yoneda extension]
  ...
  One calls left Kan extensions along the Yoneda embedding (\hyperref[def:yonedaembedding]{Definition~\ref*{def:yonedaembedding}}) \defn{Yoneda extensions}.
\end{definition}
