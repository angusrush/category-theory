...
I do my best to stick to the conventions used at the nLab (\cite{nlab}).
...
\begin{example}\label{eg:examplesofcategories}
  It is natural to imagine standard algebraic constructions as living in their own categories. For example, we have
  \begin{itemize}
...
\begin{note}
  ...
  \begin{itemize}
    \item A morphism $f$ is an isomorphism if and only if it is a bijection.
    \item A morphism $f$ is a bijection if and only if it is injective surjections.
    \item Morphisms which are both injective surjections are monic and epimorphisms.
  \end{itemize}
  Thus, a morphism is an isomorphism if and only if it is a monomorphism and an epimorphism. This is \emph{not} true in general: a morphism can be monic and epic without being an isomorphism.
