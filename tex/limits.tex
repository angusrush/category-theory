...
\end{theorem}
\begin{proof}
  Let $\mathcal{D}\colon \mathsf{J} \rightarrow \mathsf{C}$ be a finite diagram. We want to prove that $\mathcal{D}$ has a limit; we will do this by constructing a universal cone over it, i.e.
  \begin{itemize}
