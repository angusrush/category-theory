...
There are lots of different sorts of mathematical structures, each of which is good for different things. Groups are good for talking about symmetries, for instance, and rings are good for talking about all sorts of things.
...
%\subsection{Horizontal and vertical composition commute}
%\label{ssc:horizontal_and_vertical_composition_commute}
%
%\begin{theorem}
